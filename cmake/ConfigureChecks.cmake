...
include(cmake/CheckTypeAlignment.cmake)
...
check_include_files(netlink/netlink.h HAVE_NETLINK_NETLINK_H)
...
check_include_files(stdint.h HAVE_STDIO_H)    # libffi and cpython
...
find_library(HAVE_PANEL panel)
find_library(HAVE_PANELW panelw)
...
check_symbol_exists(fork1        "${CFG_HEADERS}" HAVE_FORK1)
...
cmake_push_check_state()
set(check_src ${PROJECT_BINARY_DIR}/CMakeFiles/clock_nanosleep.c)
file(WRITE ${check_src} "
#include <stdio.h>
#include <time.h>
int main() { return clock_nanosleep(0, 0, NULL, NULL); }
")
if(SUPPORT_NO_WEAK_IMPORT_FLAG)
  set(CMAKE_REQUIRED_FLAGS "-Wl,-no_weak_imports")
endif()
...
cmake_push_check_state()
set(check_src ${PROJECT_BINARY_DIR}/CMakeFiles/nanosleep.c)
file(WRITE ${check_src} "
#include <stdio.h>
#include <time.h>
int main() { return nanosleep(NULL, NULL); }
")
if(SUPPORT_NO_WEAK_IMPORT_FLAG)
  set(CMAKE_REQUIRED_FLAGS "-Wl,-no_weak_imports")
endif()
...
check_symbol_exists(pthread_cond_timedwait_relative_np "${CFG_HEADERS}" HAVE_PTHREAD_COND_TIMEDWAIT_RELATIVE_NP)
...
if(HAVE_READLINE_READLINE_H)
  ...
  check_symbol_exists(rl_compdisp_func_t          "${CFG_HEADERS}" HAVE_RL_COMPDISP_FUNC_T)
